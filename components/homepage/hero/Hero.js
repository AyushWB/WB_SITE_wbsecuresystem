...
const Section = styled.section`
  ...
  .hero-container {
    ...
    .hero-title-container {
      ...
      transform: translate(50%, -50%);
      min-width: 70rem;
      min-height: 100px; /* Ensure there's a minimum height to avoid shifts */
  ...
  /* Font display changes for CLS fix */
  @font-face {
    font-family: "Montserrat";
    src: url('/path/to/montserrat.woff2') format('woff2');
    font-display: swap; /* Add this to avoid layout shifts when fonts load */
  }
`;
