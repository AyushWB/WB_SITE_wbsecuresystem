    ...
    return (
        <Section className="section section-footer">
            ...
            <div className="container">
                <div className="main-footer-content">
                    <div className="logo-title">
                        <Link href="/" className="logo-img" aria-label="Wedding Banquets Logo">
                            <Image
                                src="/logo.png"
                    ...
                    <div className="f-section f-service">
                        <h3>Service</h3>
                        <ul className="list-unstyled">
                            <li><Link className="f-link" href={`/banquet-halls/${selectedCity}/all`}>Wedding Venues</Link></li>
                            <li><Link className="f-link" href={`/wedding-photographers/${selectedCity}/all`}>Photographers</Link></li>
                            <li><Link className="f-link" href={`/makeup-artists/${selectedCity}/all`}>Makeup Artists</Link></li>
                            <li><Link className="f-link" href={`/best-mehendi-artists/${selectedCity}/all`}>Mehendi Artists</Link></li>
                            <li><Link className="f-link" href={`/wedding-band/${selectedCity}/all`}>Wedding Band</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="f-section f-quick-links">
                        <h3>Quick Links</h3>
                        <ul className="list-unstyled">
                            <li><Link className="f-link" href="/about">About Us</Link></li>
                            <li><Link className="f-link" href="/career">Career</Link></li>
                            <li><Link className="f-link" href="/privacy_policy">Privacy Policy</Link></li>
                            <li><Link className="f-link" href="/terms_and_conditions">Terms & Conditions</Link></li>
                            <li><Link className="f-link" href="/terms_of_use">Terms Of Use</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="f-section f-contact">
                        ...
                        <ul className="list-unstyled">
                            {[
                                { icon: <IoIosCall />, href: "tel:8882198989", text: "8882198989" },
                                { icon: <IoIosCall />, href: "tel:07969071916", text: "07969071916" },
                                { icon: <IoIosCall />, href: "tel:07969100321", text: "07969100321" },
                                { icon: <IoIosCall />, href: "tel:07969100329", text: "07969100329" },
                                { icon: <MdEmail />, href: "mailto:info@weddingbanquets.in", text: "Mail us" }
                            ].map((item, index) => (
                                <li className="f-phone" key={index}>
                                    <span className="icon">{item.icon}</span>
                                    <a href={item.href} className="f-link">{item.text}</a>
                                </li>
                            ))}
                        </ul>
                    </div>
                ...
                <div className="f-icons">
                    {[
                        { href: "https://api.whatsapp.com/send?phone=918882198989&text=Hi", icon: <RiWhatsappFill className="social-icon" /> },
                        { href: "https://www.facebook.com/WeddingBanquets", icon: <RiFacebookCircleFill className="social-icon" /> },
                        { href: "https://pin.it/5gZQz1W", icon: <FaPinterest className="social-icon" /> },
                        { href: "https://www.linkedin.com/company/wedding-banquets/", icon: <RiLinkedinBoxFill className="social-icon" /> },
                        { href: "https://www.youtube.com/@weddingbanquetsofficial/", icon: <FaYoutube className="social-icon" /> },
                        { href: "https://www.instagram.com/weddingbanquetsindia/", icon: <RiInstagramFill className="social-icon" /> },
                    ].map((item, idx) => (
                        <Link href={item.href} key={idx} className="f-icon" target="_blank" aria-label="Social link">
                            {item.icon}
                        </Link>
                    ))}
                </div>
                ...
                <div className="f-copyright">
                    <p>© 2024 Wise Weddings Pvt Ltd (Wedding Banquets). All Rights Reserved.</p>
                </div>
            </div>
        </Section>
    )
