...
const VenueCard2 = dynamic(() => import("./venueCard2"), { loading: () => <Spinner2 /> });
const Filter = dynamic(() => import("../filter/Filter"), { loading: () => <div>Loading Filter...</div> });
const SearchBarVenue = dynamic(() => import("@/components/miscellaneous/SearchBarVenue"), { loading: () => <div /> });
