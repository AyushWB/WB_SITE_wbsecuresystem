...
export default function PriceListCard({
  ...
  return (
    <Wrapper className="venue-price-list-card">
      <div className="details">
        ...
        <div className="detail">
          <div className="detail-title">
            ...
            <p className="desc">Vegetarian:</p>
          </div>
          <div className="detail-content">
            <p className="desc bold">
              {veg_price ? <del>{veg_price}</del> : "On Demand"}/plate
            </p>
          </div>
        </div>
        {nonveg_price && nonveg_price !== null && nonveg_price > 0 ? (
          <div className="detail">
            <div className="detail-title">
              ...
              <p className="desc">Non Vegetarian:</p>
            </div>
            <div className="detail-content">
              <p className="desc bold">
