...
//   const images = result?.data?.[0]?.images?.split(',')[0] || 'twitter-img.png';

//   if (!isClient) return null; // ✅ Prevent SSR/client mismatch

//   return (
//     <>
//       <Head>
//         <title>{meta.meta_title || 'Wedding Banquets'}</title>
//         <meta name="description" content={meta.meta_description || ''} />
//         <meta name="keywords" content={meta.meta_keywords || ''} />
//         <link rel="canonical" href={`https://weddingbanquets.in${router.asPath}`} />
//         <meta property="og:title" content={meta.meta_title || ''} />
//         <meta property="og:description" content={meta.meta_description || ''} />
//         <meta property="og:image" content={`${process.env.MEDIA_PREFIX}/${images}`} />
//         <meta property="og:url" content={`https://weddingbanquets.in${router.asPath}`} />
//         <meta name="twitter:title" content={meta.meta_title || ''} />
//         <meta name="twitter:description" content={meta.meta_description || ''} />
//         <meta name="twitter:image" content={`${process.env.MEDIA_PREFIX}/${images}`} />
//         {meta.header_script && (
//           <script
//             type="application/ld+json"
//             dangerouslySetInnerHTML={{ __html: JSON.stringify(meta.header_script) }}
//           />
//         )}
//       </Head>
...
//         <>
//           <VenueListPage data={{ ...props, localities }} />
//           {meta.faq && <Faqs faqs={meta.faq} name={`${props.category} in ${props.city}`} />}
//           <FooterKeyword city={props.city} locality={props.locality} category={props.category} />
//           {props.locality === 'all' && (
//             <FooterLocalities city={props.city} category={props.category} localities={props.localities?.data} />
//           )}
...
//       {result?.cities && <CityVenueHall cities={result.cities} />}
//     </>
//   );
// }
...
//   const meta = result?.meta || {};
//   const images = result?.data?.[0]?.images?.split(',')[0] || 'twitter-img.png';
//   const ogImage = `${process.env.MEDIA_PREFIX}/${images}`;
...
//     const url = `${process.env.SERVER_DOMAIN}/api/venue_or_vendor_list/${category}/${city}/${locality}?${new URLSearchParams(
//       filterQuery
//     ).toString()}`;
//     const getlocalitiesURL = `${process.env.SERVER_DOMAIN}/api/locations/${city}`;
