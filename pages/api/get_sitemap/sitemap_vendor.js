...
export default async function handler(req, res) {
  ...
  const escapeXml = (unsafe) =>
    ...
    const fetchPages = async () => {
      const response = await fetch('https://cms.weddingbanquets.in/api/sitemap_vendor/1');
    ...
    const filePath = path.join(process.cwd(), 'public', 'sjfhkggkujyaegtbdrcfejkywhdg.xml');
